...
function MiddleSection(){
	...
	return (
	<div id="Community" className="h-fit flex flex-col items-center justify-center mb-40">
		...
		<section className="grid lg:grid-cols-3 gap-10 sm:grid-cols-1  mt-20">
			<div className="h-40 w-40 flex flex-col items-center justify-center">
				<img src={img1} alt="" className="h-24 w-24 rounded-full object-cover"></img>
				<h2 className="text-white font-bold">Jimmy</h2>
				<p className="text-slate-300">Content Lead</p>
			</div>
			<div className="h-40 w-40 flex flex-col items-center justify-center">
				<img src={img2} alt="" className="h-24 w-24 rounded-full object-cover"></img>
				<h2 className="text-white font-bold">Morgan</h2>
				<p className="text-slate-300">Lead Dev</p>
			</div>
			<div className="h-40 w-40 flex flex-col items-center justify-center">
				<img src={img3} alt="" className="h-24 w-24 rounded-full object-cover"></img>
			...
			<div className="h-40 w-40 flex flex-col items-center justify-center mt-8">
				<img src={img4} alt="" className="h-24 w-24 rounded-full object-cover"></img>
				<h2 className="text-white font-bold">Sally</h2>
				<p className="text-slate-300">Backend Dev</p>
			</div>
			<div className="h-40 w-40 flex flex-col items-center justify-center mt-8">
				<img src={img5} alt="" className="h-24 w-24 rounded-full object-cover"></img>
				<h2 className="text-white font-bold">Jasmine</h2>
				<p className="text-slate-300">Frontend Dev</p>
			</div>
			<div className="h-40 w-40 flex flex-col items-center justify-center mt-8">
				<img src={img6} alt="" className="h-24 w-24 rounded-full object-cover"></img>
		...
		<div className="h-30 w-30 flex flex-col items-center justify-center">
			<img src={github_img} alt="" className="h-20 w-20 rounded-full object-cover"></img>
			<h2 className="text-white font-bold">GitHub</h2>
		</div>
		<div className="h-30 w-30 flex flex-col items-center justify-center">
			<img src={vercel_img} alt="" className="h-20 w-20 rounded-full"></img>
			<h2 className="text-white font-bold">Vercel</h2>
		</div>
		<div className="h-30 w-30 flex flex-col items-center justify-center">
			<img src={tail_img} alt="" className="h-20 w-20 rounded-full object-cover"></img>
